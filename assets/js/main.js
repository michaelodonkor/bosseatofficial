...
document.getElementById("issue").maxLength = 250;
document.getElementById("tel").maxLength = 10;
document.getElementById("subject").maxLength = 20;
document.getElementById("name").maxLength = 30;
document.getElementById("name").maxLength = 40;
